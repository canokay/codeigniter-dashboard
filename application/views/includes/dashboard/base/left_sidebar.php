...
<li class="nav-item">
  <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseFour" aria-expanded="true" aria-controls="collapseFour">
	...
	?>
	<div class="bg-white py-2 collapse-inner rounded">
	  <a class="collapse-item" href="<?php echo base_url("admin/media/ekle")?>">Yeni Ortam Ekleyin</a>
	  <a class="collapse-item" href="<?php echo base_url("admin/media")?>">Ortamları Listeleyin</a>
	</div>
  </div>
