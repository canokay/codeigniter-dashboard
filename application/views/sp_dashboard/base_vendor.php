...
<head>
  ...
  <link href="<?php echo base_url("assets/sp_dashboard/")?>vendor/fontawesome-free/css/all.min.css" rel="stylesheet" type="text/css">
...
<body id="page-top">
  ...
  <script src="<?php echo base_url("assets/sp_dashboard/")?>vendor/jquery/jquery.min.js"></script>
  <script src="<?php echo base_url("assets/sp_dashboard/")?>vendor/bootstrap/js/bootstrap.bundle.min.js"></script>

  <!-- Core plugin JavaScript-->
  <script src="<?php echo base_url("assets/sp_dashboard/")?>vendor/jquery-easing/jquery.easing.min.js"></script>
