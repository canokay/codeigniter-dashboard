...
<head>
  ...
  <link href="<?php echo base_url("assets/sb_admin_2/")?>css/sb-admin-2.min.css" rel="stylesheet">
...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="text-center">
            ...
            <p class="text-gray-500 mb-0">Beklenmedik bir hata ile karşılaşıldı :(</p>
      ...
      <!-- Footer -->
			<?php $this->load->view("includes/$project/base/footer")   ?>
      <!-- End of Footer -->
